...
// $settings->add(new admin_setting_heading('block_todays_birthday',
//                                            get_string('settings_heading','block_todays_birthday'),
//                                            get_string('settings_content', 'block_todays_birthday')));
                                           
// $settings->add(new admin_setting_heading('block_todays_birthday/Label',
//                                         get_string('label','block_todays_birthday'),
//                                         get_string('label_desc', 'block_todays_birthday'), '', PARAM_TEXT));
